...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() throws ValidationException {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, sbKaNaPConfig.getKafkaBootstrapServer());
        props.put(ConsumerConfig.GROUP_ID_CONFIG, sbKaNaPConfig.getConsumerGroup());
